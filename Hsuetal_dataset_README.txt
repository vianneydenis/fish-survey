...
1. Title of Dataset: Data from: Navigating the scales of diversity in subtropical and coastal fish assemblages ascertained by eDNA and visual surveys
...
2. Author Information
	...
	Third author (Corresponding Investigator)
		Name: Dr. Vianney Denis
		Institution: Institute of Oceanography, National Taiwan University, Taipei 10617, Taiwan	


3. Year of the survey: 2021	

4. Geographic location of data collection: northern Taiwan, West Pacific

5. Funding sources that supported the collection of the data: Ocean Conservation Administration of Taiwan and Ministry of Science and Technology of Taiwan 

6. Recommended citation for this dataset: Hsu et al. (2022), Data from: Navigating the scales of diversity in subtropical and coastal fish assemblages ascertained by eDNA and visual surveys
, Dryad, Dataset.   doi:https://doi.org/??? 
...
These data were generated to navigate different scales of fish diversity and compare eDNA with visual surveys in northern Taiwan.

2. File List (10 files):
...
A detailed description of data acquisition and processing can be found in the published manuscript in the Molecular Ecology (doi: XXXXXXX).

DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_Site.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_DOV.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_UVC.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_eDNA.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_BV.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_level.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_Lw_ab.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_flow.csv
...
DATA-SPECIFIC INFORMATION FOR: Hsuetal_dataset_gd.csv
